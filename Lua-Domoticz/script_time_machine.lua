...
if (tonumber(otherdevices_svalues[Consommation])) > Consommation_sup
and otherdevices[Machine] == 'Off' then
...
-- Vérification des conditions --
if (otherdevices[Machine] == 'On' 
and uservariables[Variable_machine] == 0) then
